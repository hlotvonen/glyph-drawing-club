		...
		return (
			<div>
				...
				<GlyphFontSizeModifier 
					...
					increaseByOneCellGlyphFontSizeModifier={store.increaseByOneCellGlyphFontSizeModifier} 
					decreaseByOneCellGlyphFontSizeModifier={store.decreaseByOneCellGlyphFontSizeModifier} 
				/>
