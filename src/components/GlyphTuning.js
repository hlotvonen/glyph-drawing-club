	...
	render() {
		return (
			<div>
				...
				/>
				<GlyphOffsetX
					increaseGlyphOffsetX={store.increaseGlyphOffsetX}
					decreaseGlyphOffsetX={store.decreaseGlyphOffsetX}
				/>
				<GlyphOffsetY
					increaseGlyphOffsetY={store.increaseGlyphOffsetY}
					decreaseGlyphOffsetY={store.decreaseGlyphOffsetY}
				/>
				<GlyphRotate
