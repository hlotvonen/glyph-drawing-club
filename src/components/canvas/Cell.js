...
export const rawSvgCell = ({
	...
	>
		{
			layer1[0] === "M0 0" || store.hiddenLayers[0] === true 
				? null
				: (
					<g
						transform={`
		...
		{
			layer2[0] === "M0 0" || store.hiddenLayers[1] === true
				? null
				: (
					<g transform={`
					${/*offset X and Y: */""} 
		...
		{
			layer3[0] === "M0 0" || store.hiddenLayers[2] === true
				? null
				: (
					<g transform={`
					${/*offset X and Y: */""} 
		...
		{
			layer4[0] === "M0 0" || store.hiddenLayers[3] === true
				? null
				: (
					<g transform={`
					${/*offset X and Y: */""} 
