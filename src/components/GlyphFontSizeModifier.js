	...
	render() {
		return(
			<div>
				...
				<button onClick={this.props.decreaseByOneCellGlyphFontSizeModifier}> {'-' + store.defaultFontSize} </button>
				<button onClick={this.props.increaseByOneCellGlyphFontSizeModifier}> {'+' + store.defaultFontSize} </button> 
