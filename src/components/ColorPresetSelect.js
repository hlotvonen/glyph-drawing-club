	...
	render() {
		return (
			<div className="select_set">
				...
				>
					<option disabled defaultValue value=""> -- select a preset -- </option>
					...
					<option value="7">Riso Blue, Yellow, FluoroPink (FluoroPink Plate)</option>
					<option value="8">Riso Blue, Yellow, FluoroPink (Yellow Plate)</option>
				</select>
			</div>
		)
	}
